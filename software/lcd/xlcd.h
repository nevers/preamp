...
#define BACKLIGHT_PORT TRISCbits.RC1

/* CTRL_PORT defines the port where the control lines are connected.
 * These are just samples, change to match your application.
 */
#define RW_PIN   PORTEbits.RE2   /* PORT for RW */
#define TRIS_RW  DDREbits.RE2    /* TRIS for RW */
#define RS_PIN   PORTEbits.RE1   /* PORT for RS */
#define TRIS_RS  DDREbits.RE1    /* TRIS for RS */
#define E_PIN    PORTEbits.RE0   /* PORT for E  */
#define TRIS_E   DDREbits.RE0    /* TRIS for E  */

/* General Display Control defines */
#define CLEAR_DISPLAY 0b00000001 /* Clear all display and returns cursor to home position */
...
#define RETURN_HOME       0b00000010  /* Cursor moves to the home position */
...
#define BACKLIGHT_TIMEOUT 40000
